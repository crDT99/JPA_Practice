...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    public ModificarDatos( int num_Cliente) {
        ...
        initComponents();
        cargarDatosCliente(num_Cliente);
    }
    ...
    private void initComponents() {
        ...
        Titulo.setText("Modificación De Datos");
    ...
    private void btn_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_GuardarActionPerformed
        ...
        controlL.modificarRegistro(mPet, nombreM, razaM, colorM, observaciones, alergico, atEspecial, nombreD, cellD);
    ...
    private void cargarDatosCliente(int num_Cliente) {
        //traer Objeto de la mascota
        this.mPet = controlL.traerMascota(num_Cliente);
        
        txt_Nombre.setText(mPet.getNombre());
        txt_Raza.setText(mPet.getRaza());
        txt_Color.setText(mPet.getColor());
        txt_NombreOwner.setText(mPet.getPetOwner().getNombreOwner());
        txt_CellOwner.setText(mPet.getPetOwner().getCelOwner());
        txt_Observacion.setText(mPet.getObservaciones());
        cmb_Alergico.setSelectedIndex("Si".equals(mPet.getAlergico()) ? 1 : "No".equals(mPet.getAlergico()) ? 2 : 0 );
        cmb_AtEsp.setSelectedIndex("Si".equals(mPet.getAtencion_especial()) ? 1 : "No".equals(mPet.getAtencion_especial()) ? 2 : 0 );
    }
